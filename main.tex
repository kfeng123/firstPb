...
$F(x;\blambda_1,\ldots,\blambda_r,\sigma^2)$, the resulting test has level $\alpha$ asymptotically.
...
\begin{proposition}\label{eigenconsis}
    ...
    %$$
    $$
    \frac{\lambda_i(S)}{\blambda_i}\xrightarrow{P}1,\quad\text{ $i=1,\ldots,r$},
    $$
...
Theorem~\ref{Chenstheory1} and~\ref{Chenstheory2} imply that $T_{CQ}$ has trivial asymptotic power if $\zeta_1=\cdots=\zeta_r=\zeta^*=0$, which is equivalent to $\sum_{i=1}^r \zeta_i^2 +\zeta^*=0$, or equivalently,
$$
