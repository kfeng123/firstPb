...
%We find the ideal subspace is the orthogonal complement of the principal subspace.
%In this case, we know from the theory of principal component analysis (PCA) that the principal subspace can be estimated consistently even in high dimensional setting.
...
\begin{figure}
    ...
    \caption{Empirical power simulation. In all cases, $F$ is normal and $\beta=1$.}\label{fig:Power}
\end{figure}
