...
In this section, we consider the simulation performance of the proposed test and compare it with several other alternatives: (1) The corrected $T_{CQ}$ test procedure constructed in Section~\ref{sec:chen} (CCQ); (2)~\cite{Ma2015A}'s test (FAST); (3)~\cite{Chen2010A}'s test (CQ); (4)~\cite{Srivastava2008A}'s test (SD); (5)~\cite{Lopes2015A}'s test (LJW).
