...
%\end{remark}
 ...
 Theorem~\eqref{myPanpan} and Proposition~\ref{varianceEstimation} lead to a new asymptotic $\alpha$-level test that rejects the null hypothesis if
    $$
    Q=\frac{T_2}{\hat{\sigma}^2\sqrt{2\tau^2 p}}>\Phi^{-1}(1-\alpha).
    $$
...
Having derived the asymptotic power function of the our test, we are now in a position to provide a comparison with other tests.
